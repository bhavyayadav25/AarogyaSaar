...
REQUIRED_MODULES = {
    "AI-1F": "adaptive_interview_orchestrator.py",
    "AI-2": "clinical_safety_triage.py",
    "AI-3C": "medical_document_classifier.py",
    "AI-3D": "structured_medical_extractor.py",
    "AI-3E": "document_verification.py",
    "AI-3F": "clinical_timeline.py",
    "AI-3G": "clinical_provenance_explainability.py",
    "AI-3H": "clinical_handoff.py",
    "AI-4A": "clinical_summary.py",
    "AI-4B": "clinical_risk_assessment.py",
    "AI-4C": "clinical_decision_support.py",
    "AI-4D": "medication_reconciliation.py",
    "AI-4E": "investigation_intelligence.py",
    "AI-4F": "clinical_question_assistant.py",
    "AI-4G": "consultation_copilot.py",
    "AI-4H": "final_clinical_safety_gate.py",
    "AI-5B": "encounter_queue_workflow.py",
    "AI-5C": "doctor_workspace.py",
    "AI-5D": "consultation_workflow.py",
    "AI-5E": "clinical_triage_workflow.py",
    "AI-5G": "hospital_analytics.py",
}
