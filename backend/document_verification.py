        ...
        "items": [
            {
                ...
                "confidence_semantics": confidence_semantics("extraction_evidence_score"),
...
def apply_document_verification(extraction: Dict[str, Any], verified_items: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    for entry in verified_items:
        ...
        if "value" in entry:
            ...
            item["corrected"] = True
        item["verified"] = True
        # Human verification is a workflow state, not a fabricated 100% AI confidence score.
        item.pop("verified_confidence", None)
