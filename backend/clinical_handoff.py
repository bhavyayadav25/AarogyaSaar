...
def _document_handoff(document: Any) -> Dict[str, Any]:
    ...
    return {
        ...
        "classification_confidence_semantics": confidence_semantics("document_classification_score"),
        "verification": counts,
    ...
    for d in docs:
        ...
        if d["classification_confidence"] < 0.80:
            blockers.append({
                ...
                "document_id": d["document_id"],
                "message": "Document classification score is below the review threshold; confirm the document type manually.",
            })
